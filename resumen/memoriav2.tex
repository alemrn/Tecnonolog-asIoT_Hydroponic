...
\chapter{Esquema básico del hardware}
	...
	\subsection*{Información a tratar}
		...
		\begin{itemize}
			...
			\item \textbf{RasPi-ESP8266:} Instrucciones correspondientes a los datos externos recogidos (lluvia, temperatura, iluminación,...) desde Internet. También permite la configuración por parte del usuario y la visualización de los datos recogidos.
